...
Queuelytics was a compact task, but full of interesting challenges. I got the chance to work with tools I hadn’t touched in years — Docker, Redis, and RabbitMQ — and integrate them into a real-world backend system.
...
Built a full end-to-end system: producer → broker → consumer → database → API
